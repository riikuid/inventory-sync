            ...
            return RefreshIndicator(
              ...
              child: CustomScrollView(
                slivers: [
                  ...
                  //         runSpacing: 8,
                  //         children: [
                  //           for (var id in state.selectedCategoryIds)
                  //             _buildFilterChip(
                  //               context,
                  ...
                  //             ),
                  //           for (var id in state.selectedWarehouseIds)
                  //             _buildFilterChip(
                  //               context,
                  //               label: state.warehouses
                  //                   .firstWhere(
                  //                     (w) => w.id == id,
                  //                     orElse: () =>
                  //                         Warehouse(id: '', name: 'Unknown'),
                  //                   )
                  //                   .name,
                  //               onDeleted: () => context
                  //                   .read<CompanyItemListCubit>()
                  //                   .toggleWarehouseFilter(id),
                  //             ),
                  //           for (var id in state.selectedSectionIds)
                  //             _buildFilterChip(
                  //               context,
                  //               label:
                  //                   'Section', // Simple label since we don't have Section Name handy in state for all cases without extra lookup
                  //               onDeleted: () => context
                  //                   .read<CompanyItemListCubit>()
                  //                   .toggleSectionFilter(id),
                  //             ),

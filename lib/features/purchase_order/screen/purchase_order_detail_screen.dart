                                    ...
                                    onTap: () async {
                                      ...
                                      if (companyItem != null) {
                                            ...
                                            MaterialPageRoute(
                                              builder: (context) =>
                                                  CreateVariantScreen(
                                                    ...
                                                    defaultRackId: companyItem
                                                        .defaultRackId,
                                                    defaultRackName: companyItem
                                                        .defaultRackName,
                                                    purchasingUomId: item.uomId
                                                        .toString(),
                                                  ),
                                        ...
                                        CustomToast.error(
                                          ...
                                          description:
                                              'Item ${item.itemCode} belum disinkronisasi ke database lokal. Silakan Sync Master Data.',
                                        );
                                      }
                                    },
                                  ),
